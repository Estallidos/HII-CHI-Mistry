...
print ('-------------------------------------------------')
print ('This is HII-CHI-mistry IR v. 3.01')
...
lineas_header = [' HII-CHI-mistry-IR v.3.01 output file', 'Input file:'+input00,'Iterations for MonteCarlo: '+str(n),'Used models: '+sed_type,'']
