...
print (' ---------------------------------------------------------------------')
print ('This is HII-CHI-mistry IR v. 2.2')
...
ir_lin = ['12logOH', 'logNO', 'logU', 'HI_4m', 'HI_7m', 'SIV_10m', 'HI_12m', 'NeII_12m', 'NeV_14m', 'NeIII_15m', 'SIII_19m', 'NeV_24m', 'OIV_26m', 'SIII_33m', 'OIII_52m', 'NIII_57m', 'OIII_88m', 'NII_122m', 'NII_205m']
lin_ir_label = ['12+log(O/H)', 'log(N/O)', 'log(U)', 'HI_4m', 'HI_7m', 'SIV_10m', 'HI_12m', 'NeII_12m', 'NeV_14m', 'NeIII_15m', 'SIII_19m', 'NeV_24m', 'OIV_26m', 'SIII_33m', 'OIII_52m', 'NIII_57m', 'OIII_88m', 'NII_122m', 'NII_205m']
...
# Calculation of N/O
   ...
   if NIII_57m[tab] <= 0 or (OIII_52m[tab] <= 0 and OIII_88m[tab] <= 0 and SIII_18m[tab] <= 0 and SIII_33m[tab] <= 0 and SIV_10m[tab] <= 0):
      ...
      for monte in range(0,n,1):
         ...
         #if (SIII_33_obs <= 0 and  SIII_18_obs <= 0 and SIV_10_obs > 0):
            #N3S4_obs = np.log10(NIII_57_obs / SIV_10_obs )
         #if (SIII_18_obs > 0 and SIV_10_obs <= 0):
            #N3S3a_obs = np.log10(NIII_57_obs / (SIII_18_obs) )
         #if (SIII_33_obs > 0 and SIV_10_obs <= 0):
            #N3S3b_obs = np.log10(NIII_57_obs / (SIII_33_obs) )
...
# Calculation of N/O error
         ...
         for index in grid:
            ...
            #if N3S4_obs == -10: 
               #CHI_N3S4 = 0
            #elif index['SIV_10m'] == 0 or index['NIII_57m'] == 0:
               #CHI_N3S4 = tol_max
            #else:   
               #CHI_N3S4 = (np.log10(index['NIII_57m']/index['SIV_10m'])- N3S4_obs)**2/np.log10(index['NIII_57m']/index['SIV_10m'])
...
# Calculation of O/H and logU
   ...
   for monte in range(0,n,1):
      ...
      if HI_4m_obs == 0 or (NeII_12m_obs == 0 and NeIII_15m_obs == 0 and NeV_14m_obs == 0): #or (sed==3 and (NeIII_15m_obs > 0 or NeV_14m_obs > 0) and HI_4m_obs > 0):
         Ne235a_obs = -10
      else:
         Ne235a_obs = np.log10((NeII_12m_obs + NeIII_15m_obs + NeV_14m_obs)/HI_4m_obs)
      if HI_7m_obs == 0 or (NeII_12m_obs == 0 and NeIII_15m_obs == 0 and NeV_14m_obs == 0): #or (sed==3 and (NeIII_15m_obs > 0 or NeV_14m_obs > 0) and HI_7m_obs > 0):
         Ne235b_obs = -10
      else:
         Ne235b_obs = np.log10((NeII_12m_obs + NeIII_15m_obs + NeV_14m_obs)/HI_7m_obs)
      if HI_12m_obs == 0 or (NeII_12m_obs == 0 and NeIII_15m_obs == 0 and NeV_14m_obs == 0): #or (sed==3 and (NeIII_15m_obs > 0 or NeV_14m_obs > 0) and HI_12m_obs > 0):
         Ne235c_obs = -10
      else:
         Ne235c_obs = np.log10((NeII_12m_obs + NeIII_15m_obs + NeV_14m_obs)/HI_12m_obs)
      if HI_4m_obs == 0 or (NeII_12m_obs == 0 and NeIII_15m_obs == 0 and NeV_24m_obs == 0): #or (sed==3 and (NeIII_15m_obs > 0 or NeV_24m_obs > 0) and HI_4m_obs > 0):
         Ne235d_obs = -10
      else:
         Ne235d_obs = np.log10((NeII_12m_obs + NeIII_15m_obs + NeV_24m_obs)/HI_4m_obs)
      if HI_7m_obs == 0 or (NeII_12m_obs == 0 and NeIII_15m_obs == 0 and NeV_24m_obs == 0): #or (sed==3 and (NeIII_15m_obs > 0 or NeV_24m_obs > 0) and HI_7m_obs > 0):
         Ne235e_obs = -10
      else:
         Ne235e_obs = np.log10((NeII_12m_obs + NeIII_15m_obs + NeV_24m_obs)/HI_7m_obs)
      if HI_12m_obs == 0 or (NeII_12m_obs == 0 and NeIII_15m_obs == 0 and NeV_24m_obs == 0): #or (sed==3 and (NeIII_15m_obs > 0 or NeV_24m_obs > 0) and HI_12m_obs > 0):
         Ne235f_obs = -10
      else:
      ...
      if ((NeIII_15m_obs == 0 and NeII_12m_obs == 0) or NeV_14m_obs == 0 ): #or  (sed==3 and NeIII_15m_obs > 0 and NeV_14m_obs > 0):
         Ne23Ne5a_obs = -10
      else:
         Ne23Ne5a_obs = np.log10(( (NeIII_15m_obs + NeII_12m_obs) / NeV_14m_obs))
      if ((NeIII_15m_obs == 0 and NeII_12m_obs == 0) or NeV_24m_obs == 0  ): #or (sed==3 and NeIII_15m_obs > 0 and NeV_24m_obs > 0):
         Ne23Ne5b_obs = -10
      else:
      ...
      if S34a_obs == -10 and S34b_obs == -10 and S34c_obs == -10 and S34d_obs == -10 and S34e_obs == -10 and S34f_obs == -10 and Ne2Ne3_obs == -10 and S3S4a_obs == -10 and S3S4b_obs == -10 and N23a_obs == -10 and N23b_obs == -10 and N23c_obs == -10 and N2N3a_obs == -10 and O3N2a_obs == -10 and O3N2b_obs == -10 and N23d_obs == -10 and N23e_obs == -10 and N23f_obs == -10 and N2N3b_obs == -10 and O3N2c_obs == -10 and O3N2d_obs == -10 and Ne235a_obs == -10 and Ne235b_obs == -10 and Ne235c_obs == -10 and Ne235d_obs == -10 and Ne235e_obs == -10 and Ne235f_obs == -10 and Ne23Ne5a_obs == -10 and Ne23Ne5b_obs == -10 and O34a_obs == -10 and O34b_obs == -10 and O34c_obs == -10 and O34d_obs == -10 and O34e_obs == -10 and O34f_obs == -10 and O3O4a_obs == -10 and O3O4b_obs == -10 and N3a_obs == -10 and N3b_obs == -10 and N3c_obs == -10: 
         OH = 0
         logU = 0
      else:
         #CHI_Ne23a = 0
         ...
         for index in grid_c:
            #if Ne23a_obs == -10: 
               #CHI_Ne23a = 0
            #elif index['HI_4m'] == 0 or index['NeII_12m'] == 0 or index['NeIII_15m'] == 0:
               #CHI_Ne23a = tol_max
            #else:   
               #CHI_Ne23a = (np.log10((index['NeII_12m']+index['NeIII_15m'])/index['HI_4m'])- Ne23a_obs)**2/np.log10((index['NeII_12m']+index['NeIII_15m'])/index['HI_4m'])
            #if Ne23b_obs == -10: 
               #CHI_Ne23b = 0
            #elif index['HI_7m'] == 0 or index['NeII_12m'] == 0 or index['NeIII_15m'] == 0:
               #CHI_Ne23b = tol_max
            #else:   
               #CHI_Ne23b = (np.log10((index['NeII_12m']+index['NeIII_15m'])/index['HI_7m'])- Ne23b_obs)**2/np.log10((index['NeII_12m']+index['NeIII_15m'])/index['HI_7m'])
            #if Ne23c_obs == -10: 
               #CHI_Ne23c = 0
            #elif index['HI_12m'] == 0 or index['NeII_12m'] == 0 or index['NeIII_15m'] == 0:
               #CHI_Ne23c = tol_max
            #else:   
               #CHI_Ne23c = (np.log10((index['NeII_12m']+index['NeIII_15m'])/index['HI_12m'])- Ne23c_obs)**2/np.log10((index['NeII_12m']+index['NeIII_15m'])/index['HI_12m'])       
            if Ne2Ne3_obs == -10: 
               CHI_Ne2Ne3 = 0
            ...
            if Ne235c_obs == -10: 
               ...
               CHI_Ne235c = (np.log10((index['NeII_12m']+index['NeIII_15m']+index['NeV_14m'])/index['HI_12m'])- Ne235c_obs)**2/np.log10((index['NeII_12m']+index['NeIII_15m']+index['NeV_24m'])/index['HI_12m'])
            if Ne235d_obs == -10: 
               CHI_Ne235d = 0
            ...
            #if Ne2Ne5a_obs == -10: 
               #CHI_Ne2Ne5a = 0
            #elif index['NeII_12m'] == 0 or index['NeV_14m'] == 0:
               #CHI_Ne2Ne5a = tol_max
            #else:   
               #CHI_Ne2Ne5a = (np.log10((index['NeII_12m']/index['NeV_14m']))- Ne2Ne5a_obs)**2/np.log10((index['NeII_12m']/index['NeV_14m']))
            #if Ne2Ne5b_obs == -10: 
               #CHI_Ne2Ne5b = 0
            #elif index['NeII_12m'] == 0 or index['NeV_24m'] == 0:
               #CHI_Ne2Ne5b = tol_max
            #else:   
               #CHI_Ne2Ne5b = (np.log10((index['NeII_12m']/index['NeV_24m']))- Ne2Ne5b_obs)**2/np.log10((index['NeII_12m']/index['NeV_24m']))
            #if Ne3Ne5a_obs == -10: 
               #CHI_Ne3Ne5a = 0
            #elif index['NeIII_15m'] == 0 or index['NeV_14m'] == 0:
               #CHI_Ne3Ne5a = tol_max
            #else:   
               #CHI_Ne3Ne5a = (np.log10((index['NeIII_15m']/index['NeV_14m']))- Ne3Ne5a_obs)**2/np.log10((index['NeIII_15m']/index['NeV_14m']))
            #if Ne3Ne5b_obs == -10: 
               #CHI_Ne3Ne5b = 0
            #elif index['NeIII_15m'] == 0 or index['NeV_24m'] == 0:
               #CHI_Ne3Ne5b = tol_max
            #else:   
            ...
            CHI_OH = (CHI_Ne2Ne3**2 + CHI_S34a**2 + CHI_S34b**2 + CHI_S34c**2 + CHI_S34d**2 +CHI_S34e**2+CHI_S34f**2+CHI_S3S4a**2+CHI_S3S4b**2+CHI_N23a**2+CHI_N23b**2+CHI_N23c**2+CHI_N2N3a**2+CHI_O3N2a**2+CHI_O3N2b**2+CHI_N23d**2+CHI_N23e**2+CHI_N23f**2+CHI_N2N3b**2+CHI_O3N2c**2+CHI_O3N2d**2 + CHI_O34a**2 + CHI_O34b**2 + CHI_O34c**2 + CHI_O34d**2 + CHI_O34e**2 + CHI_O34f**2 + CHI_O3O4a**2 +CHI_O3O4b**2 + CHI_Ne235a**2 + CHI_Ne235b**2 + CHI_Ne235c**2 + CHI_Ne235d**2 + CHI_Ne235e**2 + CHI_Ne235f**2 + CHI_Ne23Ne5a**2 + CHI_Ne23Ne5b**2 + CHI_Ne35a**2 + CHI_Ne35b**2 + CHI_Ne35c**2 + CHI_Ne35d**2 + CHI_Ne35e**2 + CHI_Ne35f**2 + CHI_Ne3Ne5a**2 + CHI_Ne3Ne5b**2 + CHI_N3a**2 + CHI_N3b**2 + CHI_N3c**2)**0.5
         ...
         if sed >= 3 and HI_4m[tab] == 0 and HI_7m[tab] == 0 and HI_12m[tab] == 0:
            OH = 0
         elif OH_p == 0:
            OH = 0
         else:
...
#Calculation of error of O/H and logU
      ...
      if S34a_obs == -10 and S34b_obs == -10 and S34c_obs == -10 and S34d_obs == -10 and S34e_obs == -10 and S34f_obs == -10 and Ne2Ne3_obs == -10 and S3S4a_obs == -10 and S3S4b_obs == -10 and N23a_obs == -10 and N23b_obs == -10 and N23c_obs == -10 and N2N3a_obs == -10 and O3N2a_obs == -10 and O3N2b_obs == -10 and N23d_obs == -10 and N23e_obs == -10 and N23f_obs == -10 and N2N3b_obs == -10 and O3N2c_obs == -10 and O3N2d_obs == -10 and Ne235a_obs == -10 and Ne235b_obs == -10 and Ne235c_obs == -10 and Ne235d_obs == -10 and Ne235e_obs == -10 and Ne235f_obs == -10 and Ne23Ne5a_obs == -10 and Ne23Ne5b_obs == -10 and O34a_obs == -10 and O34b_obs == -10 and O34c_obs == -10 and O34d_obs == -10 and O34e_obs == -10 and O34f_obs == -10 and O3O4a_obs == -10 and O3O4b_obs == -10 and N3a_obs == -10 and N3b_obs == -10 and N3c_obs == -10: 
         ...
         for index in grid_c:
            ...
            if Ne23Ne5a_obs == -10: 
               CHI_Ne23Ne5a = 0
            elif index['NeV_14m'] == 0 or (index['NeII_12m'] == 0 and index['NeIII_15m'] == 0):
               CHI_Ne23Ne5a = tol_max
            else:   
            ...
            if Ne23Ne5b_obs == -10: 
               CHI_Ne23Ne5b = 0
            elif index['NeV_24m'] == 0 or (index['NeII_12m'] == 0 and index['NeIII_15m'] == 0):
               CHI_Ne23Ne5b = tol_max
            else:   
            ...
            CHI_OH = (CHI_Ne2Ne3**2 + CHI_S34a**2 + CHI_S34b**2 + CHI_S34c**2 + CHI_S34d**2 +CHI_S34e**2+CHI_S34f**2+CHI_S3S4a**2+CHI_S3S4b**2+CHI_N23a**2+CHI_N23b**2+CHI_N23c**2+CHI_N2N3a**2+CHI_O3N2a**2+CHI_O3N2b**2+CHI_N23d**2+CHI_N23e**2+CHI_N23f**2+CHI_N2N3b**2+CHI_O3N2c**2+CHI_O3N2d**2 + CHI_Ne235a**2 + CHI_Ne235b**2 + CHI_Ne235c**2 + CHI_Ne235d**2 + CHI_Ne235e**2 + CHI_Ne235f**2 + CHI_Ne23Ne5a**2 + CHI_Ne23Ne5b**2 + CHI_O34a**2 + CHI_O34b**2 + CHI_O34c**2 + CHI_O34d**2 +CHI_O34e**2+CHI_O34f**2+CHI_O3O4a**2+CHI_O3O4b**2 + CHI_Ne35a**2 + CHI_Ne35b**2 + CHI_Ne35c**2 + CHI_Ne35d**2 + CHI_Ne35e**2 + CHI_Ne35f**2 + CHI_Ne3Ne5a**2 + CHI_Ne3Ne5b**2 + CHI_N3a**2 + CHI_N3b**2 + CHI_N3c**2 )**0.5
      ...
      if inter == 0 or OH == 0:
         ...
         for index in igrid:
            ...
            if Ne23Ne5b_obs == -10: 
               ...
               CHI_Ne23Ne5b = (np.log10(( (index['NeII_12m']+index['NeIII_15m'])/index['NeV_12m']))- Ne23Ne5b_obs)**2/np.log10(( (index['NeII_12m']+index['NeIII_15m'])/index['NeV_24m']))
            ...
            if S34f_obs == -10: 
               ...
               CHI_S34f = (np.log10((index['OIV_26m']+index['OIII_88m'])/index['HI_12m'])- O34f_obs)**2/np.log10((index['OIV_26m']+index['OIII_88m'])/index['HI_12m'])
            if O3O4a_obs == -10: 
               CHI_O3O4a = 0
            elif index['OIV_26m'] == 0 or index['OIII_52m'] == 0 : 
               CHI_O3O4a = tol_max
            ...
            if N3a_obs == -10: 
               ...
               CHI_N3a = (np.log10((index['NIII_57m']+index['NII_122m'])/index['HI_4m'])- N3a_obs)**2/np.log10((index['NIII_57m'])/index['HI_4m'])
            if N3b_obs == -10: 
               CHI_N3b = 0
            elif index['HI_7m'] == 0 or (index['NIII_57m'] == 0): 
               CHI_N3b = tol_max
            else:   
               CHI_N3b = (np.log10((index['NIII_57m']+index['NII_122m'])/index['HI_7m'])- N3b_obs)**2/np.log10((index['NIII_57m'])/index['HI_7m'])
            if N3c_obs == -10: 
               CHI_N3c = 0
            elif index['HI_12m'] == 0 or (index['NIII_57m'] == 0): 
               CHI_N3c = tol_max
...
lineas_header = [' HII-CHI-mistry-IR v.2.2 output file', 'Input file:'+input00,'Iterations for MonteCarlo: '+str(n),'Used models: '+sed_type,'Library file used : '+file_lib_2, 'Template used to constraint grid of models: '+const_file,'']
...
header = '\n'.join(lineas_header)
np.savetxt('.'.join(input00.split('.')[:-1])+'_hcm-ir-output.dat',output,fmt=' '.join(['%s']*1+['%.3f']*(len(output.dtype.names)-8)+['%i']+['%.2f']*6), header=header)
