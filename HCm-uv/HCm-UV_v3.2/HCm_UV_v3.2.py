...
print (' ---------------------------------------------------------------------')
print (' This is HII-CHI-mistry for UV version 3.2')
...
print ('and 0 for missing information.')
print ('---------------------------------------------------------------------')
...
grid1 = np.loadtxt('C17_cha_1Myr_v3.1_uv.dat')
grid2 = np.loadtxt('C17_cha_1Myr_logU_adapted_emp_v3.1_uv.dat')
grid3 = np.loadtxt('C17_cha_1Myr_logU-CO_adapted_emp_v3.1_uv.dat')
...
lineas_header = [' HII-CHI-mistry_UV v.3.2 output file', 'Input file:'+input00,'Iterations for MonteCarlo: '+str(n),'Used models: POPSTAR with IMF Chabrier with age = 1 Mry','','Lya  eLya   1549   e1549 1665  e1665  1909   e1909  Hbeta   eHbeta  5007    e5007  i O/H     eO/H  C/O    eC/O  logU   elogU']
