...
print (' ---------------------------------------------------------------------')
print ('This is HII-CHI-mistry v. 5.5')
...
if question2a == False:
   teff_pagb = 1 #Choose value of the effecctive temperature: (1) T_eff = 50 kK; (2) T_eff = 100 kK; (3) T_eff = 150 kK
...
lineas_header = ['HII-CHI-mistry v.5.5 output file', 'Input file: '+input00,'Iterations for MonteCarlo: '+str(n),'Used models: '+sed_type,'Library file used : '+file_lib_2, 'Template used to constraint grid of models: '+const_file,'']
