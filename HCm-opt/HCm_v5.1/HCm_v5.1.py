...
if sed==1:
   ...
   grid1 = np.loadtxt('C17_bpass_v5.0.dat')
   grid2 = np.loadtxt('C17_bpass_logU_adapted_emp_v5.0.dat')
   grid3 = np.loadtxt('C17_bpass_logU-NO_adapted_emp_v5.0.dat')
   if inter == 0:
...
lineas_header = [' HII-CHI-mistry v.5.1 output file', 'Input file:'+input00,'Iterations for MonteCarlo: '+str(n),'Used models: '+sed_type,'','ID   O2Hb eO2Hb  Ne3Hb  eNeHb O3aHb  eO3aHb O3nHb  eO3nHb N2Hb   eN2Hb  S2Hb   eS2Hb  i O/H     eO/H  N/O    eN/O  logU   elogU']
