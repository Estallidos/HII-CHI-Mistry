...
print (' ---------------------------------------------------------------------')
print ('This is HII-CHI-mistry v. 6.0')
...
question4 = interactive #Question required to introduce a particular file by the user (only required if "sed" is set 6)
...
if sed==1:
   ...
   file_lib_2 = 'C17_POPSTAR_1myr_SO_var.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib_2, 'r') as file6b:
      for line in file6b:
         if line[0] == '#':
            n_comments += 1
   grid_aux2 = np.genfromtxt('Libraries_opt/'+file_lib_2,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
   ...
   with open('Libraries_opt/'+file_lib, 'r') as file7:
      for line in file7:
         if line[0] == '#':
            n_comments += 1
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)  
   file_lib_2 = 'C17_BPASS_IMF135_mup300_1myr_SO_var.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib_2, 'r') as file6b:
      for line in file6b:
...
#AGN MODEL FOR alpha_OX = -0.8, efrac = 2% and logU in [-4.0, -0.5]
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -0.8 and free electron fraction = 2%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -0.8 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O. ')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -0.8 and free electron fraction = 2% interpolated.'
...
#AGN MODEL FOR alpha_OX = -0.8, efrac = 98% and logU in [-4.0, -0.5]
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -0.8 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -0.8 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -0.8 and free electron fraction = 98% interpolated.'
...
#AGN MODEL FOR alpha_OX = -1.0, efrac = 2% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_AGN_alpha10_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   ...
   if inter == 0:
      ...
      print ('No interpolation for the AGN a(ox) = -1.0 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.0 and free electron fraction = 2% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.0 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')
      res_NO = 0.125
 
#AGN MODEL FOR alpha_OX = -1.0, efrac = 98% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==2 and efrac == 2:
   file_lib = 'C17_AGN_alpha10_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.0 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.0 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.0 and free electron fraction = 98% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.0 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')
    
#AGN MODEL FOR alpha_OX = -1.2, efrac = 2% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==3 and efrac == 1:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.2 and free electron fraction = 2%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.2 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.2 and free electron fraction = 2% interpolated.'
...
#AGN MODEL FOR alpha_OX = -1.2, efrac = 98% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==3 and efrac == 2:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.2 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.2 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.2 and free electron fraction = 98% interpolated.'
...
#AGN MODEL FOR alpha_OX = -1.4, efrac = 2% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_AGN_alpha14_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.4 and free electron fraction = 2%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.4 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.4 and free electron fraction = 2% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.4 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')
      res_NO = 0.125
 
#AGN MODEL FOR alpha_OX = -1.4, efrac = 98% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==4 and efrac == 2:
   file_lib = 'C17_AGN_alpha14_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.4 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.4 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.4 and free electron fraction = 98% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.4 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')

#AGN MODEL FOR alpha_OX = -1.6, efrac = 2% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==5 and efrac == 1:
   file_lib = 'C17_AGN_alpha16_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.6 and free electron fraction = 2%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.6 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.6 and free electron fraction = 2% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.6 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')
      res_NO = 0.125
 
#AGN MODEL FOR alpha_OX = -1.6, efrac = 98% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==5 and efrac == 2:
   file_lib = 'C17_AGN_alpha16_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.6 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.6 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.6 and free electron fraction = 98% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.6 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')

#AGN MODEL FOR alpha_OX = -1.8, efrac = 2% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==6 and efrac == 1:
   file_lib = 'C17_AGN_alpha18_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.8 and free electron fraction = 2%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.8 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.8 and free electron fraction = 2% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.8 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')
      res_NO = 0.125
 
#AGN MODEL FOR alpha_OX = -1.8, efrac = 98% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==6 and efrac == 2:
   file_lib = 'C17_AGN_alpha18_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -1.8 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -1.8 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -1.8 and free electron fraction = 98% interpolated.'
      print ('Interpolation for the AGN a(ox) = -1.8 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')

#AGN MODEL FOR alpha_OX = -2.0, efrac = 2% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==7 and efrac == 1:
   file_lib = 'C17_AGN_alpha20_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -2.0 and free electron fraction = 2%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -2.0 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -2.0 and free electron fraction = 2% interpolated.'
      print ('Interpolation for the AGN a(ox) = -2.0 with 2% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')
      res_NO = 0.125
 
#AGN MODEL FOR alpha_OX = -2.0, efrac = 98% and logU in [-4.0, -0.5]
elif sed==3 and alpha ==7 and efrac == 2:
   file_lib = 'C17_AGN_alpha20_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
   ...
   grid_aux = np.genfromtxt('Libraries_opt/'+file_lib,dtype=None,names=True, encoding = 'ascii', skip_header=n_comments)
   if inter == 0:
      sed_type = 'Double composite AGN, a(OX) = -2.0 and free electron fraction = 98%. No interpolation.'
      print ('No interpolation for the AGN a(ox) = -2.0 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.1dex for O/H and 0.125dex for N/O')
      res_NO = 0.125
   elif inter == 1:
      sed_type = 'Double composite AGN, a(OX) = -2.0 and free electron fraction = 98% interpolated.'
      print ('Interpolation for the AGN a(ox) = -2.0 with 98% free electrons models is going to be used.')
      print ('The grid has a resolution of 0.01 dex for O/H and 0.0125 dex for N/O')

#pAGB MODEL FOR T_eff = 50 kK, efrac = 2% and logU in [-4.0, -0.5]
elif sed==4 and teff_pagb==1 and efrac == 1:
   file_lib = 'C17_PAGB_T50kk_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
...
#pAGB MODEL FOR T_eff = 50 kK, efrac = 98% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_PAGB_T50kk_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
...
#pAGB MODEL FOR T_eff = 100 kK, efrac = 2% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_PAGB_T100kk_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
...
#pAGB MODEL FOR T_eff = 100 kK, efrac = 98% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_PAGB_T100kk_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
...
#pAGB MODEL FOR T_eff = 150 kK, efrac = 2% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_PAGB_T150kk_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
...
#pAGB MODEL FOR T_eff = 150 kK, efrac = 98% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_PAGB_T150kk_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
...
#ADAF model, efrac = 2% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_ADAF_efrac02_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file10:
      for line in file10:
...
#ADAF model, efrac = 98% and logU in [-4.0, -0.5]
   ...
   file_lib = 'C17_ADAF_efrac98_CNfix.dat'
   #Counting comments:
   n_comments = 0
   with open('Libraries_opt/'+file_lib, 'r') as file11:
      for line in file11:
...
for tab in range(0,input1.size,1):
   ...
   # Selection of grid
      ...
      if OHff == 0 or SII_6725[tab] <= 0 or (SIII_9069[tab] <= 0 and SIII_6312[tab] <= 0) or sed >= 3:
         SHff = 0
         eSHff = 0
      else:
         grid_mac = []
         for index in grid_aux2:
            if (np.abs(index['12logOH'] - OHff) > (np.abs(eOHff)+0.1)) and (np.abs(index['logU']- np.abs(logUff)) > (np.abs(elogUff)+0.25)):
               continue
            else:
               grid_mac.append(index[[name_col for name_col in grid_aux2.dtype.names]])
               format_array = []
               for name_col in grid_aux2.dtype.names:
                  format_array.append((name_col, grid_aux2[0][name_col].dtype))
            grid_S = np.array(grid_mac, dtype=format_array)
         for monte in range(0,n,1):
            SH_p = 0
            den_SH = 0
            SH_e = 0
            ...
            for index in grid_S:
               ...
               if S23_obs == 0:
                  CHI_SH = (CHI_S23a**2 + CHI_S2S3a**2  )**0.5
               else:
                  CHI_SH = (CHI_RSIII**2 + CHI_S23**2 + CHI_S2S3**2)**0.5

               if CHI_SH == 0:
                  SH_p = SH_p
                  den_SH = den_SH
               else:
                  SH_p = index['12logSH'] / (CHI_SH)**2 + SH_p
                  den_SH = 1 / (CHI_SH)**2 + den_SH

            SH = SH_p / den_SH

            #Calculation of SH error
            CHI_S23 = 0
            CHI_S23a = 0
            CHI_RSIII = 0
            CHI_S2S3 = 0
            ...
            for index in grid_S:
               ...
               if CHI_SH == 0:
                  ...
                  SH_e = (index['12logSH'] - SH)**2 / (CHI_SH)**2 + SH_e
                  den_SH_e = 1 / (CHI_SH)**2 + den_SH_e  
...
lineas_header = ['HII-CHI-mistry v.6.0 output file', 'Input file: '+input00,'Iterations for MonteCarlo: '+str(n),'Used models: '+sed_type,'Library file used : '+file_lib_2, 'Template used to constraint grid of models: '+const_file,'']

line_label = '{:10}  '.format(output.dtype.names[0])
for ind2 in range(1, len(output.dtype.names)-9):
   line_label += '{:10}  '.format(output.dtype.names[ind2])


line_label += '{:10}   {:10}   {:10}   {:10}   {:10}   {:10}   {:10}   {:10}   {:10}'.format('i', 'O/H',    'eO/H',  'S/H'   ,'eS/H'   ,'N/O' ,   'eN/O' , 'logU*',   'elogU*')
lineas_header.append(line_label)
header = '\n'.join(lineas_header)
np.savetxt('.'.join(input00.split('.')[:-1])+'_hcm-output.dat',output,fmt=' '.join(['%s']*1+['%.3f']*(len(output.dtype.names)-10)+['%i']+['%.2f']*8), header=header)
