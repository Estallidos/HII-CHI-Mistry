...
print ' ---------------------------------------------------------------------'
print 'This is HII-CHI-mistry v. 3.1'
...
while question:
   ...
   if inter == 0:
      grid1 = np.loadtxt('C17_cha_1Myr_v3.1.dat')
      grid2 = np.loadtxt('C17_cha_1Myr_logU_adapted_emp_v3.1.dat')
      grid3 = np.loadtxt('C17_cha_1Myr_logU-NO_adapted_emp_v3.1.dat')
      ...
      grid1 = np.loadtxt('C17_cha_1Myr_v3.1int.dat')
      grid2 = np.loadtxt('C17_cha_1Myr_logU_adapted_emp_v3.1int.dat')
      grid3 = np.loadtxt('C17_cha_1Myr_logU-NO_adapted_emp_v3.1int.dat')
      grid1i = np.loadtxt('C17_cha_1Myr_v3.1int.dat')
      grid2i = np.loadtxt('C17_cha_1Myr_logU_adapted_emp_v3.1int.dat')
      grid3i = np.loadtxt('C17_cha_1Myr_logU-NO_adapted_emp_v3.1int.dat')
      print ''
