...
print (' ---------------------------------------------------------------------')
print ('This is HII-CHI-mistry-Teff-IR v. 2.3')
print (' See Perez-Montero et al (2023c) for details')
...
question1 = interactive #Question for the grids of models
question2 = interactive #Question for the geometry of photoionization models
question3 = interactive #Question to use or not interpolation for the grids
...
while question1:
   ...
   if sed == '1' or sed == '2' or sed == '3': question1 = False
   print ('')
...
while question2:
   ...
   if geo == '1' or geo == '2': question2 = False
print('')
...
while question3:
   ...
   if inter == '0' or inter == '1': question3 = False
print ('')
...
for tab in range(0,len(input1),1):
   ...
   # Calculation of T and log U
         ...
         if (Ar2Ar3_obs == -10 and Ne2Ne3_obs == -10 and S3S4a_obs == -10 and S3S4b_obs == -10 and  N2N3a_obs == -10 and N2N3b_obs == -10):
            Teff = 0
            logU = 0
         else:
            CHI_Ar2Ar3 = 0
...
lineas_header = [' HII-CHI-mistry-Teff-IR v.2.3 output file', 'Input file:'+input00,'Iterations for MonteCarlo: '+str(n),'Used models: '+sed_type, 'Library file used : '+file_lib, '']
